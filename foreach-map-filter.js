...
function showFirstAndLast(arr){
    let new_arr = [];
    arr.forEach(function(value,i,arr){
        new_arr.push(value.charAt(0)+value.charAt(value.length - 1));
    });
    return new_arr;
}
...
function vowelCount(str){
   let new_arr = {};
   const vowel = "aeiou";
   Array.from(str).forEach(function(value,index,arr){
        if(vowel.includes(value.toLowerCase())){
            if(new_arr[value.toLowerCase()]==null){
                new_arr[value.toLowerCase()] = 1;
            }else{
                new_arr[value.toLowerCase()]++;
            }
        }
   });
   return new_arr;
...
function filterByValue(arr, key) {
    return arr.filter(function(value,i,arr){
...
function removeVowels(str) {
    const vowels = "aeiou"
    return Array.from(str).filter(function(value, index,arr){
